...
void CfindMatch::run(void) {
  ...
  for (int t = 0; t < TIME; ++t) {
	  LOGI("CfindMatch run 2");
    m_expand.run();
LOGI("CfindMatch run 3");
    m_filter.run();
        LOGI("CfindMatch run 4");
    updateThreshold();
    cout << "STATUS: ";
